classdef Qbmove2DofMD < Qbmove2Dof
    % Qbmove with 2nd order dynamics
    ...
    properties
        name = 'Qbmove 2 DoF with 2nd order motor dynamics';
...
%             [xdot3, xdot3_x, xdot3_u] = model.motor_dynamics_2nd(x(9:12,:), u(4:5,:));
            [xdot3, xdot3_x, xdot3_u] = model.motor_dynamics_2nd(x(9:12,:), u(3:4,:));
            
            xdot = [xdot1; xdot2; xdot3];%此处为xddot
